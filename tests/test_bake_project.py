...
@contextmanager
def inside_dir(dirpath: builtins.str):  # type: ignore[no-untyped-def]
    """
...
@contextmanager
def bake_in_temp_dir(cookies, *args, **kwargs):  # type: ignore[no-untyped-def]
    """
...
def run_inside_dir(command: builtins.str, dirpath: builtins.str):  # type: ignore[no-untyped-def]
    """
...
def check_output_inside_dir(command: builtins.str, dirpath: builtins.str):  # type: ignore[no-untyped-def]
    "Run a command from inside a given directory, returning the command output"
    with inside_dir(dirpath):
        return subprocess.check_output(shlex.split(command))


def test_year_compute_in_license_file(cookies) -> None:  # type: ignore[no-untyped-def]
...
def project_info(  # type: ignore[no-untyped-def]
    result,
) -> typing.Tuple[builtins.str, builtins.str, builtins.str]:
...
def test_bake_with_defaults(cookies) -> None:  # type: ignore[no-untyped-def]
    with bake_in_temp_dir(cookies) as result:
...
def test_bake_and_run_tests(cookies) -> None:  # type: ignore[no-untyped-def]
    with bake_in_temp_dir(cookies) as result:
        assert result.project_path.is_dir()
...
def test_bake_with_apostrophe_and_run_tests(cookies) -> None:  # type: ignore[no-untyped-def]
...
def test_bake_without_author_file(cookies) -> None:  # type: ignore[no-untyped-def]
...
def test_make_help(cookies) -> None:  # type: ignore[no-untyped-def]
    with bake_in_temp_dir(cookies) as result:
...
def test_bake_selecting_license(cookies) -> None:  # type: ignore[no-untyped-def]
    license_strings = {
        "MIT license": "MIT ",
...
def test_bake_not_open_source(cookies) -> None:  # type: ignore[no-untyped-def]
    with bake_in_temp_dir(
...
def test_bake_with_console_script_files(cookies) -> None:  # type: ignore[no-untyped-def]
...
def test_bake_with_argparse_console_script_files(cookies) -> None:  # type: ignore[no-untyped-def]
